            ...
            <div class="container">
                ...
                <!-- <div class="collapse navbar-collapse" id="navbarSupportedContent"> -->
                    ...
                    <!-- <ul class="navbar-nav mr-auto">
                      <li><a class="nav-link active" aria-current="page" href="/index">Accueil</a></li>
                      <li><a class="nav-link active" aria-current="page" href="/posts">Blog</a></li>
...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <div class="envelope">
          ...
          <ul class="rigth navbar-nav me-auto mb-2 mb-lg-0">
           <span class=""> <i class="fa fa-user-circle" aria-hidden="true"></i>
            Admin Admin</span>
          </ul> 
 ...
 <div class="wrapper">
  <div class="sidebar">
    ...
    <ul class="lesicons">
      <li><a href="" class="fas fa-home"></a>Dashboad</li>
      <li><a href="" class="fas fa-user"></a>Users</li>
      <li><a href="" class="fas fa-home"></a>CMS</li>
      <li><a href="" class="fas fa-home"></a>General Setting</li>
      <li><a href="" class="fas fa-home"></a>Module Setting</li>
    </ul>
  </div>
